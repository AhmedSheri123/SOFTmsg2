...
def correct_fuzzy_entries(language_code):
    ...
    locale_path = os.path.join('F:/mostql/softmsg2', 'locale', language_code, 'LC_MESSAGES', 'django.po')
    ...
    for entry in po_file:
        ...
        if 'fuzzy' in entry.flags or (entry.msgstr == '' and 'pages' in str(entry.occurrences)):
